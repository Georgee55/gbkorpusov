public class Feeding {
        ...
        public static void main(String[] args) {
            ...
            Cat[] cat = new Cat[3];
            cat[0] = new Cat("Котик", 120, 4);
            cat[1] = new Cat("Кот", 100, 5);
            cat[2] = new Cat("Кошак", 40, 2);
            Plate plate = new Plate(700);
            System.out.println("Существует три кота: " + cat[0].getName() + ", " + cat[1].getName() + " и " + cat[2].getName() + ", которые хотят есть каждые " + cat[0].getSatietyTime() + ", " + cat[1].getSatietyTime() + " и " + cat[2].getSatietyTime() + " час(а) соответственно.");
